...
export type ResignMemberMutation = {
	insert_memberStatusActivities_one?: Maybe<
		Pick<MemberStatusActivities, "memberId" | "status"> & {
			memberResigned?: Maybe<
				Pick<
					MemberResigned,
					"reasonType" | "memberId" | "reasonDetail" | "agreement"
				>
			>;
		}
	>;
...
export type GetMembersByStatusQuery = {
	memberStatusActivityLatest: Array<
		Pick<
...
export const ResignMemberDocument = gql`
  ...
  insert_memberStatusActivities_one(object: $activityInput) {
    ...
    `;
export type ResignMemberMutationFn = Apollo.MutationFunction<
	ResignMemberMutation,
 ...
 * });
 */
export function useResignMemberMutation(
	...
	return Apollo.useMutation<
		ResignMemberMutation,
		ResignMemberMutationVariables
	>(ResignMemberDocument, options);
}
export type ResignMemberMutationHookResult = ReturnType<
	typeof useResignMemberMutation
>;
export type ResignMemberMutationResult =
	Apollo.MutationResult<ResignMemberMutation>;
export type ResignMemberMutationOptions = Apollo.BaseMutationOptions<
	ResignMemberMutation,
	ResignMemberMutationVariables
>;
 ...
 * });
 */
export function useGetActiveMemberQuery(
	baseOptions: Apollo.QueryHookOptions<
		GetActiveMemberQuery,
		GetActiveMemberQueryVariables
	> &
		(
			| { variables: GetActiveMemberQueryVariables; skip?: boolean }
			| { skip: boolean }
		),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<GetActiveMemberQuery, GetActiveMemberQueryVariables>(
		GetActiveMemberDocument,
		options,
	);
}
export function useGetActiveMemberLazyQuery(
	...
	return Apollo.useLazyQuery<
		GetActiveMemberQuery,
		GetActiveMemberQueryVariables
	>(GetActiveMemberDocument, options);
}
export function useGetActiveMemberSuspenseQuery(
...
export type GetActiveMemberQueryHookResult = ReturnType<
	typeof useGetActiveMemberQuery
>;
export type GetActiveMemberLazyQueryHookResult = ReturnType<
	typeof useGetActiveMemberLazyQuery
>;
export type GetActiveMemberSuspenseQueryHookResult = ReturnType<
	typeof useGetActiveMemberSuspenseQuery
>;
 ...
 * });
 */
export function useGetMembersByStatusQuery(
	baseOptions: Apollo.QueryHookOptions<
		GetMembersByStatusQuery,
		GetMembersByStatusQueryVariables
	> &
		(
			| { variables: GetMembersByStatusQueryVariables; skip?: boolean }
			| { skip: boolean }
		),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<
		GetMembersByStatusQuery,
		GetMembersByStatusQueryVariables
	>(GetMembersByStatusDocument, options);
}
export function useGetMembersByStatusLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		GetMembersByStatusQuery,
		GetMembersByStatusQueryVariables
	>,
...
export function useGetMembersByStatusSuspenseQuery(
	baseOptions?: Apollo.SuspenseQueryHookOptions<
		GetMembersByStatusQuery,
		GetMembersByStatusQueryVariables
	>,
...
export type GetMembersByStatusQueryHookResult = ReturnType<
	typeof useGetMembersByStatusQuery
>;
export type GetMembersByStatusLazyQueryHookResult = ReturnType<
	typeof useGetMembersByStatusLazyQuery
>;
export type GetMembersByStatusSuspenseQueryHookResult = ReturnType<
	typeof useGetMembersByStatusSuspenseQuery
>;
export type GetMembersByStatusQueryResult = Apollo.QueryResult<
	GetMembersByStatusQuery,
	GetMembersByStatusQueryVariables
>;
