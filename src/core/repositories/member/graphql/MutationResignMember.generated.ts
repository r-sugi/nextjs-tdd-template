...
export type ResignMemberMutationVariables = Types.Exact<{
	activityInput: Types.MemberStatusActivities_Insert_Input;
}>;

export type ResignMemberMutation = {
	insert_memberStatusActivities_one?: Types.Maybe<
		Pick<Types.MemberStatusActivities, "memberId" | "status"> & {
