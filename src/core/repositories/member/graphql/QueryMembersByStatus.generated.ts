...
export type GetMembersByStatusQueryVariables = Types.Exact<{
...
export type GetMembersByStatusQuery = {
	memberStatusActivityLatest: Array<
		Pick<
			Types.MemberStatusActivityLatest,
			"status" | "createdAt" | "id" | "memberId"
		> & {
			memberActive?: Types.Maybe<
				Pick<
					Types.MemberActive,
					| "statusActivityId"
					| "postalCode"
			...
			memberBanned?: Types.Maybe<
				...
				>
			>;
			memberPendingActivation?: Types.Maybe<
				Pick<
					Types.MemberPendingActivation,
					"createdAt" | "email" | "memberId" | "statusActivityId"
				>
			>;
			memberResigned?: Types.Maybe<
				Pick<
					Types.MemberResigned,
					| "agreement"
					| "createdAt"
					| "memberId"
					| "reasonDetail"
				...
				>
			>;
			memberRestored?: Types.Maybe<
				Pick<
					Types.MemberRestored,
					| "createdAt"
					| "memberId"
					| "operatedBy"
					| "reason"
