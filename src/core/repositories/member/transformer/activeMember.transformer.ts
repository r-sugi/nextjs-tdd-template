...
export const transform = (res: GetActiveMemberQueryResult): ActiveMember | null => {
  ...
  const responseActiveMember = res.data.memberStatusActivityLatest[0] as MemberActive;
